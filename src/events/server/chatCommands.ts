...
export const event: Event = {
    ...
    async execute(client, message: Message) {
        ...
        if (message.content == '!sendrealmdev') {
            var row = new MessageActionRow()
                .addComponents(
                    new MessageButton()
                        .setLabel('Resource Packs')
                        .setStyle('LINK')
                        .setEmoji('952029816817877062')
                        .setURL('https://discordapp.com/channels/753438334663000116/753465326993276939'),

                        new MessageButton()
                        .setLabel('Behavior Packs')
                        .setStyle('LINK')
                        .setEmoji('952029816817877062')
                        .setURL('https://discordapp.com/channels/753438334663000116/753465326993276939'),
